        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <p className="text-lg font-bold tracking-tight mb-3">
              www.noblemirrorcapital.com <span className="text-primary">Noble Mirror Capital</span>
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {products.map(({ to, label }) => (
                <li key={label}>
                  <Link to={to} className="text-slate-400 hover:text-primary text-sm transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
