        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {items.map(({ title, points, cta }) => (
            <div key={title} className="p-6 rounded-xl bg-dark-card border border-dark-border">
              ...
              <Link href="/platform" className="inline-flex items-center gap-1 px-4 py-2 rounded-lg bg-slate-700/50 text-slate-300 hover:bg-slate-600/50 text-sm font-medium">
                {cta} →
              </Link>
            </div>
          ))}
